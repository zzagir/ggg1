# Scrapy settings for castoramaparcer project
#
...
BOT_NAME = 'castoramaparcer'

IMAGES_STORE = 'photos'

SPIDER_MODULES = ['castoramaparcer.spiders']
NEWSPIDER_MODULE = 'castoramaparcer.spiders'
...
ITEM_PIPELINES = {
   'castoramaparcer.pipelines.CastoramaparcerPipeline': 300,
   'castoramaparcer.pipelines.CastoramaPhotosPipeline': 200
}
